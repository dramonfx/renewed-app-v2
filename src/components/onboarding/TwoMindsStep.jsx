  ...
  return (
    <div className="text-center">
      ...
      >
        {/* Old Mind */}
        <motion.div
          className={`p-8 rounded-2xl border-2 transition-all duration-300 cursor-pointer shadow-lg ${
            selectedMind === 'old' 
              ? 'border-sacred-purple-400 bg-sacred-purple-50' 
              : 'border-gray-200 bg-white hover:border-sacred-purple-200 hover:bg-white hover:shadow-xl'
          }`}
        ...
        <motion.div
          className={`p-8 rounded-2xl border-2 transition-all duration-300 cursor-pointer shadow-lg ${
            selectedMind === 'new' 
              ...
              : 'border-gray-200 bg-white hover:border-sacred-gold-200 hover:bg-white hover:shadow-xl'
          }`}
