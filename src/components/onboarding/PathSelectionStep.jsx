  ...
  const getColorClasses = (color, isSelected) => {
    const baseClasses = {
      'sacred-gold': {
        ...
        bg: isSelected ? 'bg-sacred-gold-50' : 'bg-white hover:bg-gray-50 shadow-lg hover:shadow-xl',
      ...
      'sacred-blue': {
        ...
        bg: isSelected ? 'bg-sacred-blue-50' : 'bg-white hover:bg-gray-50 shadow-lg hover:shadow-xl',
      ...
      'sacred-purple': {
        ...
        bg: isSelected ? 'bg-sacred-purple-50' : 'bg-white hover:bg-gray-50 shadow-lg hover:shadow-xl',
