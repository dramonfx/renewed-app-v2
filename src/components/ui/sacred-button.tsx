...
const SacredButton = forwardRef<HTMLButtonElement, SacredButtonProps>(
  (
    ...
    const baseClasses =
      'font-semibold transition-all duration-300 cursor-pointer inline-flex items-center justify-center';

    const variantClasses: Record<ButtonVariant, string> = {
      primary: 'sacred-button',
      gold: 'sacred-gold-button',
      ghost:
        'bg-transparent text-sacred-blue-600 hover:bg-sacred-blue-50 border-2 border-sacred-blue-200 hover:border-sacred-blue-300',
    };
