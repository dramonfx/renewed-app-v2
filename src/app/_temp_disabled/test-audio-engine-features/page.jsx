        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '14px', lineHeight: '1.6' }}>
              <div>
                Buffer Health: <span style={{ color: '#34d399' }}>{state.bufferHealth}%</span>
              </div>
              <div>
                Loading Progress: <span style={{ color: '#fbbf24' }}>{state.loadingProgress}%</span>
              </div>
              <div>
                Memory Usage:{' '}
          ...
          >
            ...
            <div style={{ fontSize: '14px', lineHeight: '1.6' }}>
              ...
              <div>
                Network: <span style={{ color: '#fbbf24' }}>{state.networkCondition}</span>
              </div>
              <div>
                Downlink:{' '}
          ...
          >
            ...
            <div style={{ fontSize: '14px', lineHeight: '1.6' }}>
              ...
              <div>
                Play Time:{' '}
                <span style={{ color: '#34d399' }}>{Math.round(state.currentTime)}s</span>
              </div>
              <div>
                Retry Queue:{' '}
